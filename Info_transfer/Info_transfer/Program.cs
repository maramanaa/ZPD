...
namespace ExcelReaderWriter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string folderPath = @"C:\Users\katri\Desktop\Maija ZPD\ZPD_Latvija_Arpus_Civilizacijas_Excel";
            string[] excelFiles = Directory.GetFiles(folderPath, "*.xlsx");

            // Define the path for the output Excel file
            string outputFilePath = @"C:\Users\katri\Desktop\Maija ZPD\ZPD_Latvija_Arpus_Civilizacijas_Kopsavilkums_Excel.xlsx";
